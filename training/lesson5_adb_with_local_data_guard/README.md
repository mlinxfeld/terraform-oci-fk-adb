...
martin_lin@codeeditor:terraform-oci-fk-adb (eu-frankfurt-1)$ cd training/lesson5_adb_with_local_data_guard/
```
...
```
martin_lin@codeeditor:lesson5_adb_with_local_data_guard (eu-frankfurt-1)$ cp terraform.tfvars.example terraform.tfvars

martin_lin@codeeditor:lesson5_adb_with_local_data_guard (eu-frankfurt-1)$ vi terraform.tfvars
...
```
martin_lin@codeeditor:lesson5_adb_with_local_data_guard (eu-frankfurt-1)$ terraform init
...
```
martin_lin@codeeditor:lesson5_adb_with_local_data_guard (eu-frankfurt-1)$ terraform apply
...
```
martin_lin@codeeditor:lesson5_adb_with_local_data_guard (eu-frankfurt-1)$ terraform destroy 
