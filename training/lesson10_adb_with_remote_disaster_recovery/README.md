...
martin_lin@codeeditor:terraform-oci-fk-adb (eu-frankfurt-1)$ cd training/lesson10_adb_with_remote_disaster_recovery/
```
...
```
martin_lin@codeeditor:lesson10_adb_with_remote_disaster_recovery (eu-frankfurt-1)$ cp terraform.tfvars.example terraform.tfvars

martin_lin@codeeditor:lesson10_adb_with_remote_disaster_recovery (eu-frankfurt-1)$ vi terraform.tfvars
...
```
martin_lin@codeeditor:lesson10_adb_with_remote_disaster_recovery (eu-frankfurt-1)$ terraform init
...
```
martin_lin@codeeditor:lesson10_adb_with_remote_disaster_recovery (eu-frankfurt-1)$ terraform destroy 
