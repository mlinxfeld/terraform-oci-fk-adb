...
martin_lin@codeeditor:terraform-oci-fk-adb (eu-frankfurt-1)$ cd training/lesson6_adb_with_manual_backup/
```
...
```
martin_lin@codeeditor:lesson6_adb_with_manual_backup (eu-frankfurt-1)$ cp terraform.tfvars.example terraform.tfvars
...
```
martin_lin@codeeditor:lesson6_adb_with_manual_backup (eu-frankfurt-1)$ terraform init
...
```
martin_lin@codeeditor:lesson6_adb_with_manual_backup (eu-frankfurt-1)$ terraform apply
...
```
martin_lin@codeeditor:lesson6_adb_with_manual_backup (eu-frankfurt-1)$ terraform destroy 
